...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<PyAttentionInputs>(m, "PyAttentionInputs")
        ...
        .def_readwrite("indexer_pool_mixed_graph_mode", &PyAttentionInputs::indexer_pool_mixed_graph_mode)
        ...
        .def_readwrite("decode_request_id", &PyAttentionInputs::decode_request_id)
